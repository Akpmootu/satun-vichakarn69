          ...
          <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
                  <div className="flex items-center gap-2">
                       ...
                       <span>พัฒนาโดย กลุ่มงานสุขภาพดิจิทัล สำนักงานสาธารณสุขจังหวัดสตูล 2569 | <a href="#" onClick={(e) => {e.preventDefault(); Swal.fire({title: 'รายละเอียดอัปเดต v1.3.54', html: '<ul class="text-left space-y-2 text-sm"><li>🔧 <b>Bug Fix:</b> แก้ไขการแสดงข้อมูลในหน้าต่างแก้ไขคะแนนให้สัมพันธ์กับตาราง Score Data และคำนวณคะแนนรวมตามค่าถ่วงน้ำหนัก (v1.3.54)</li><li>📊 <b>Feature:</b> เพิ่มระบบส่งออกคะแนนเป็นไฟล์ Excel แบ่งตามสาขาวิชา และแก้การแสดงผลประเภทผลงานให้ครบ (v1.3.53)</li><li>📝 <b>Feature:</b> เพิ่มแท็บจัดการคะแนนสำหรับแอดมิน เพื่อดูภาพรวมคะแนน (v1.3.52)</li><li>🔧 <b>Bug Fix:</b> แก้ไขปัญหารีเซ็ตรหัสผ่าน (v1.3.51)</li></ul>', icon: 'info', confirmButtonColor: '#0ea5e9'}); }}>v1.3.54</a></span>
                  </div>
