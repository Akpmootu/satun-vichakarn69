          ...
          <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
                  <div className="flex items-center gap-2">
                       ...
                       <span>พัฒนาโดย กลุ่มงานสุขภาพดิจิทัล สำนักงานสาธารณสุขจังหวัดสตูล 2569 | <a href="#" onClick={(e) => {e.preventDefault(); Swal.fire({title: 'รายละเอียดอัปเดต v1.3.52', html: '<ul class="text-left space-y-2 text-sm"><li>📝 <b>Feature:</b> เพิ่มแท็บจัดการคะแนนสำหรับแอดมิน เพื่อดูภาพรวมคะแนน ตรวจสอบสถานะการประเมินจากกรรมการ และสามารถแก้ไขปรับแก้คะแนนได้ (v1.3.52)</li><li>🔧 <b>Bug Fix:</b> แก้ไขปัญหารีเซ็ตรหัสผ่านและส่วนของผู้ดูแลระบบไม่ทำงานเนื่องจาก VITE_SUPABASE_URL ขาดหายไปในฝั่ง Backend (v1.3.51)</li><li>🔒 <b>Feature:</b> ผู้ดูแลระบบสามารถกำหนดรหัสผ่านใหม่แบบระบุเองได้ตอนรีเซ็ตรหัสผ่าน (v1.3.50)</li><li>📅 <b>Feature:</b> นำตารางกำหนดการแสดงผลในหน้าหลักสำหรับทุกคนเพื่อความสะดวกในการดูข้อมูล และเพิ่มแท็บกำหนดการแยกชัดเจน (v1.3.48)</li></ul>', icon: 'info', confirmButtonColor: '#0ea5e9'}); }}>v1.3.52</a></span>
                  </div>
