          ...
          <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
                  <div className="flex items-center gap-2">
                       ...
                       <span>พัฒนาโดย IT SSJ Satun 2569 | <a href="#" onClick={(e) => {e.preventDefault(); Swal.fire({title: 'รายละเอียดอัปเดต v1.3.12', html: '<ul class="text-left space-y-2 text-sm"><li>📢 <b>Telegram Alert:</b> แก้ไขการแจ้งเตือนไม่ส่งปัญหาจาก JSON Format ของลิงก์ผลงานและตัวอักษรพิเศษ (v1.3.12)</li><li>📱 <b>Telegram Alert:</b> เพิ่มรายละเอียดการแจ้งเตือนเมื่อมีการส่งผลงานใหม่ พร้อมปุ่มลิงก์ตรวจสอบ (v1.3.11)</li><li>📊 <b>Telegram Summary:</b> ปรับปรุงรายงานสรุปประจำวันให้ครอบคลุมยอดสะสมทั้งหมด (v1.3.11)</li><li>📰 <b>Welcome Modal:</b> หน้า Welcome สามารถปรับเปลี่ยนรูปแบนเนอร์ได้จากแอดมิน (v1.3.9)</li></ul>', icon: 'info', confirmButtonColor: '#0ea5e9'}); }}>v1.3.12</a></span>
                  </div>
