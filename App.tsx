          ...
          <div className="max-w-7xl mx-auto px-6">
              ...
              <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-slate-500">
                  <div className="flex items-center gap-2">
                       ...
                       <span>พัฒนาโดย IT SSJ Satun 2569 | <a href="#" onClick={(e) => {e.preventDefault(); Swal.fire({title: 'รายละเอียดอัปเดต v1.3.5', html: '<ul class="text-left space-y-2 text-sm"><li>📱 <b>Telegram Alert:</b> อัปเดตการส่งข้อมูล Telegram ให้มีข้อมูลผู้ใช้ ตำแหน่ง สังกัด ไฟล์แนบผลงาน (v1.3.5)</li><li>⏱️ <b>Telegram Cron:</b> เพิ่มระบบส่งรายงานสรุปยอดเข้า Telegram แบบรายวันอัตโนมัติ เวลา 17.00 น. (v1.3.5)</li><li>📈 <b>Analytics Dashboard:</b> เพิ่มกราฟแยก 15 สาขา แบบ Real-time</li><li>✅ <b>ระบบส่งกลับแก้ไข:</b> แอดมินสามารถตีกลับแก้ไข และแสดงกรอบสีแดงในหน้าประวัติ</li><li>🔒 <b>Co-Author Security:</b> ป้องกันการแก้ไขรายชื่อผู้ร่วมที่ลงทะเบียนในระบบ</li><li>🖼️ <b>Admin Table:</b> ใช้รูปภาพ Profile ผู้ใช้แบบ Avatar</li><li>🛡️ <b>Admin Panel:</b> Popup จัดการข้อมูลผู้ใช้สามารถเลื่อนลงได้ (Scrollable)</li><li>🔑 <b>Groups & Branches:</b> แสดงหมายเลขสาขาพร้อมชื่อกลุ่มสาขา ในทุกส่วนของการแสดงผล</li><li>☁️ <b>Pagination:</b> รองรับ Pagination หน้าประวัติ (v1.3.4)</li></ul>', icon: 'info', confirmButtonColor: '#0ea5e9'}); }}>v1.3.5</a></span>
                  </div>
